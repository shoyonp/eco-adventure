...
import cycle from "../assets/assets/Mountain Biking in the Alps.jpg";

const Activities = () => {
  return (
    <div>
        <h2 className="mb-5 text-4xl font-extrabold text-center">There Are Many <span className="italic font-medium text-green-700">Activities</span> In Each <span className="italic font-medium text-green-700">Destination</span></h2>
      ...
      <div className=" p-4 rounded-lg shadow-xl">
        ...
        <h2 className="text-lg font-bold mb-3 mt-3">Hiking Route With Team</h2>
      ...
      <div className=" p-4 rounded-lg shadow-xl">
        ...
        <h2 className="text-lg font-bold mb-3 mt-3">Bike Routes With Family</h2>
        <p className=" font-normal text-gray-500 mb-3">
          Enjoy fun-filled family biking adventures along safe, picturesque
          routes, perfect for creating cherished memories and outdoor excitement
        </p>
        <p className="font-medium text-base mb-3 text-green-700 flex items-center gap-2">
          <a href="">LEARN MORE</a>
          <FaLongArrowAltRight />
